...
mixin _$AddSubscriptionState {
 ...
 int get currentStep; CatalogService? get selectedService; bool get isCustom; String? get customName; ServiceCategory? get customCategory; int? get customColorValue; ServicePlan? get selectedPlan; double? get customAmount; BillingFrequency get frequency; DateTime? get startDate; int? get alertDaysBefore;
...
@override
int get hashCode => Object.hash(runtimeType,currentStep,selectedService,isCustom,customName,customCategory,customColorValue,selectedPlan,customAmount,frequency,startDate,alertDaysBefore);

@override
String toString() {
  return 'AddSubscriptionState(currentStep: $currentStep, selectedService: $selectedService, isCustom: $isCustom, customName: $customName, customCategory: $customCategory, customColorValue: $customColorValue, selectedPlan: $selectedPlan, customAmount: $customAmount, frequency: $frequency, startDate: $startDate, alertDaysBefore: $alertDaysBefore)';
}
...
@useResult
$Res call({
 int currentStep, CatalogService? selectedService, bool isCustom, String? customName, ServiceCategory? customCategory, int? customColorValue, ServicePlan? selectedPlan, double? customAmount, BillingFrequency frequency, DateTime? startDate, int? alertDaysBefore
});
...
/// Create a copy of AddSubscriptionState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentStep = null,Object? selectedService = freezed,Object? isCustom = null,Object? customName = freezed,Object? customCategory = freezed,Object? customColorValue = freezed,Object? selectedPlan = freezed,Object? customAmount = freezed,Object? frequency = null,Object? startDate = freezed,Object? alertDaysBefore = freezed,}) {
...
as CatalogService?,isCustom: null == isCustom ? _self.isCustom : isCustom // ignore: cast_nullable_to_non_nullable
as bool,customName: freezed == customName ? _self.customName : customName // ignore: cast_nullable_to_non_nullable
as String?,customCategory: freezed == customCategory ? _self.customCategory : customCategory // ignore: cast_nullable_to_non_nullable
as ServiceCategory?,customColorValue: freezed == customColorValue ? _self.customColorValue : customColorValue // ignore: cast_nullable_to_non_nullable
as int?,selectedPlan: freezed == selectedPlan ? _self.selectedPlan : selectedPlan // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int currentStep,  CatalogService? selectedService,  bool isCustom,  String? customName,  ServiceCategory? customCategory,  int? customColorValue,  ServicePlan? selectedPlan,  double? customAmount,  BillingFrequency frequency,  DateTime? startDate,  int? alertDaysBefore)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AddSubscriptionState() when $default != null:
return $default(_that.currentStep,_that.selectedService,_that.isCustom,_that.customName,_that.customCategory,_that.customColorValue,_that.selectedPlan,_that.customAmount,_that.frequency,_that.startDate,_that.alertDaysBefore);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int currentStep,  CatalogService? selectedService,  bool isCustom,  String? customName,  ServiceCategory? customCategory,  int? customColorValue,  ServicePlan? selectedPlan,  double? customAmount,  BillingFrequency frequency,  DateTime? startDate,  int? alertDaysBefore)  $default,) {final _that = this;
switch (_that) {
case _AddSubscriptionState():
return $default(_that.currentStep,_that.selectedService,_that.isCustom,_that.customName,_that.customCategory,_that.customColorValue,_that.selectedPlan,_that.customAmount,_that.frequency,_that.startDate,_that.alertDaysBefore);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int currentStep,  CatalogService? selectedService,  bool isCustom,  String? customName,  ServiceCategory? customCategory,  int? customColorValue,  ServicePlan? selectedPlan,  double? customAmount,  BillingFrequency frequency,  DateTime? startDate,  int? alertDaysBefore)?  $default,) {final _that = this;
switch (_that) {
case _AddSubscriptionState() when $default != null:
return $default(_that.currentStep,_that.selectedService,_that.isCustom,_that.customName,_that.customCategory,_that.customColorValue,_that.selectedPlan,_that.customAmount,_that.frequency,_that.startDate,_that.alertDaysBefore);case _:
  return null;
...
class _AddSubscriptionState implements AddSubscriptionState {
  const _AddSubscriptionState({this.currentStep = 0, this.selectedService, this.isCustom = false, this.customName, this.customCategory, this.customColorValue, this.selectedPlan, this.customAmount, this.frequency = BillingFrequency.monthly, this.startDate, this.alertDaysBefore});
...
@override final  ServiceCategory? customCategory;
@override final  int? customColorValue;
